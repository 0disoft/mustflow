...
const commandRelatedTests = new Map([
	...
	['explain', ['explain.test.js', 'explain-verify.test.js', 'router.test.js']],
...
const relatedRules = [
	...
	{ match: /^src\/core\/source-anchors\.ts$/u, tests: ['check-source-anchors.test.js', 'explain.test.js', 'index.test.js', 'search.test.js'] },
