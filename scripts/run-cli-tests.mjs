...
const commandRelatedTests = new Map([
	...
	['explain', ['explain.test.js', 'explain-authority.test.js', 'explain-command.test.js', 'explain-skills.test.js', 'explain-source-anchor.test.js', 'explain-verify.test.js', 'router.test.js']],
...
const relatedRules = [
	...
	{ match: /^src\/cli\/lib\/local-index\.ts$/u, tests: ['index.test.js', 'search.test.js', 'explain-command.test.js'] },
	...
	{ match: /^src\/core\/change-(classification|verification)\.ts$/u, tests: ['classify.test.js', 'verify.test.js', 'explain-verify.test.js', 'schema.test.js'] },
