...
const relatedRules = [
	...
	{ match: /^src\/cli\/script-packs\/code-change-impact\.ts$/u, tests: codeOutlineContractTests },
	...
	{ match: /^src\/cli\/script-packs\/repo-secret-risk-scan\.ts$/u, tests: codeOutlineContractTests },
	{ match: /^src\/cli\/script-packs\/test-regression-selector\.ts$/u, tests: codeOutlineContractTests },
