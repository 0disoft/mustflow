...
const commandRelatedTests = new Map([
	...
	['dashboard', ['dashboard.test.js', ...schemaSmokeTests]],
	['docs', ['docs.test.js']],
	...
	['run', ['run.test.js', ...schemaSmokeTests]],
...
const relatedRules = [
	...
	{ match: /^src\/cli\/lib\/package-info\.ts$/u, tests: ['dashboard.test.js', 'router.test.js', 'run.test.js'] },
	...
	{ match: /^src\/cli\/commands\/run\//u, tests: ['run.test.js', ...schemaSmokeTests] },
	...
	{ match: /^src\/core\/command-intent-eligibility\.ts$/u, tests: ['run.test.js', ...verifyTests, 'security-fuzz.test.js', ...schemaSmokeTests] },
	...
	{ match: /^src\/core\/dashboard-verification\.ts$/u, tests: ['dashboard.test.js', 'verify.test.js', 'verify-completion-verdict.test.js', ...schemaSmokeTests] },
	...
	{ match: /^src\/core\/verification-decision-graph\.ts$/u, tests: ['verify.test.js', 'verify-completion-verdict.test.js', 'dashboard.test.js', ...schemaSmokeTests] },
	{ match: /^src\/core\/verification-scheduler\.ts$/u, tests: ['verify-plan-scheduler.test.js', 'run.test.js'] },
	...
	{ match: /^tests\/cli\/([^/]+\.test\.js)$/u, testsForMatch: ([, testName]) => [testName] },
	{
		...
		tests: ['check-command-contracts.test.js', 'explain-command.test.js', 'index.test.js', 'run.test.js', ...verifyTests],
	},
