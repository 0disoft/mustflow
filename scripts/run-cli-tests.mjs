...
const relatedRules = [
	...
	{ match: /^src\/cli\/lib\/package-info\.ts$/u, tests: ['dashboard.test.js', 'router.test.js', ...runTests] },
	{ match: /^src\/cli\/lib\/command-registry\.ts$/u, tests: [...runTests, 'dashboard.test.js', 'router.test.js'] },
	{ match: /^src\/cli\/lib\/run-plan\.ts$/u, tests: [...runTests, ...schemaSmokeTests] },
	{ match: /^src\/cli\/lib\/run-receipt\.ts$/u, tests: [...runTests, 'dashboard.test.js', ...schemaSmokeTests] },
