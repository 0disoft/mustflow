...
export function createTestSelection(allCliTests, options = {}) {
	...
	const dashboardTests = ['dashboard.test.js', 'dashboard-request.test.js'];
	...
	const commandRelatedTests = new Map([
		...
		['plugin', ['agent-plugin-bundles.test.js']],
		['check', [...checkTests]],
		['classify', ['classify.test.js']],
		['context', ['context.test.js']],
		['contract-lint', ['contract-lint.test.js']],
		['dashboard', [...dashboardTests]],
		['docs', ['docs.test.js']],
		['doctor', ['doctor.test.js']],
		['explain', explainTests],
		['explain-verify', ['explain-verify.test.js']],
		['handoff', ['handoff.test.js']],
		...
		['verify', [...verifyTests, 'explain-verify.test.js']],
		['version', [...routerSmokeTests]],
		['version-sources', ['version-sources.test.js']],
	]);
	...
	const relatedRules = [
		...
		{ match: /^src\/cli\/lib\/run-context\.ts$/u, tests: runTests },
		{
			match: /^src\/cli\/lib\/manifest-lock\.ts$/u,
			tests: [...runTests, 'check.test.js', 'update.test.js', 'manifest-lock-accept-go.test.js'],
		},
		{ match: /^src\/cli\/lib\/run-root-trust\.ts$/u, tests: runTests },
		{ match: /^src\/cli\/lib\/run-plan\.ts$/u, tests: [...runTests] },
		{ match: /^src\/cli\/lib\/run-receipt\.ts$/u, tests: [...runTests, ...dashboardTests] },
		{ match: /^src\/cli\/lib\/validation(?:\.ts|\/)/u, tests: [...checkTests] },
		{ match: /^src\/cli\/lib\/agent-context\.ts$/u, tests: skillRouteTests },
		{ match: /^src\/cli\/commands\/skill\.ts$/u, tests: skillRouteTests },
		{ match: /^src\/cli\/commands\/run\//u, tests: [...runTests] },
		{ match: /^src\/cli\/commands\/verify\//u, tests: [...verifyTests, 'explain-verify.test.js'] },
		...
		{ match: /^src\/core\/command-intent-eligibility\.ts$/u, tests: [...runTests, ...verifyTests, 'security-fuzz.test.js'] },
		{ match: /^src\/core\/command-classification\.ts$/u, tests: ['classify.test.js', 'impact.test.js', ...verifyTests] },
		{ match: /^src\/core\/command-contract-rules\.ts$/u, tests: ['check-command-contracts.test.js', ...runTests] },
		{ match: /^src\/core\/config-loading\.ts$/u, tests: ['check-config-validation.test.js', 'doctor.test.js', ...runTests] },
		{ match: /^src\/core\/run-receipt\.ts$/u, tests: [...runTests] },
		{
			match: /^src\/core\/workspace-command-authority\.ts$/u,
			tests: ['check-config-validation.test.js', 'workspace.test.js', ...runTests],
		},
		{ match: /^src\/core\/contract-lint\.ts$/u, tests: ['contract-lint.test.js'] },
		...
		{ match: /^src\/core\/adapter-compatibility\.ts$/u, tests: ['adapters.test.js'] },
		{ match: /^src\/core\/agent-plugin-bundle\.ts$/u, tests: ['agent-plugin-bundles.test.js'] },
		{ match: /^src\/core\/contract-models\.ts$/u, tests: ['check-command-contracts.test.js'] },
		{ match: /^src\/core\/(release-version-validation|version-impact|version-sources|version-sync-policy)\.ts$/u, tests: versioningTests },
		{ match: /^src\/core\/handoff-record\.ts$/u, tests: ['handoff.test.js'] },
		...
		{ match: /^tools\/native-crash-fixture-parser\/(?:Cargo\.(?:toml|lock)|src\/.*\.rs)$/u, tests: ['native-crash-fixture-external-validation.test.js'] },
		{ match: /^src\/core\/authority-resolution\.ts$/u, tests: ['check-doc-authority.test.js', 'explain-authority.test.js'] },
		{ match: /^src\/core\/check-issues\.ts$/u, tests: ['check.test.js'] },
