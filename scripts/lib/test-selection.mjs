...
export function createTestSelection(allCliTests, options = {}) {
	...
	const relatedRules = [
		...
		{ match: /^src\/core\/config-loading\.ts$/u, tests: ['check-config-validation.test.js', 'doctor.test.js', ...runTests, ...schemaSmokeTests] },
		{ match: /^src\/core\/run-receipt\.ts$/u, tests: [...runTests, ...schemaSmokeTests] },
		{
