...
export const precomputedSelectionRequests = [
	...
	{ mode: 'related', changedFiles: ['.mustflow/config/manifest.lock.toml'] },
	...
	{ mode: 'related', changedFiles: ['.mustflow/skills/hetzner-cloud-change/SKILL.md'] },
	{ mode: 'related', changedFiles: ['templates/default/locales/en/.mustflow/skills/hetzner-cloud-change/SKILL.md'] },
	{ mode: 'related', changedFiles: ['.mustflow/skills/INDEX.md'] },
	{ mode: 'related', changedFiles: ['templates/default/manifest.toml'] },
	{ mode: 'related', changedFiles: ['tests/cli/helpers/skill-contracts.js'] },
	{ mode: 'skill-contracts', changedFiles: ['.mustflow/skills/hetzner-cloud-change/SKILL.md'] },
