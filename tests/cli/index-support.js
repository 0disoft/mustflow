...
export const LOCAL_INDEX_ALLOWED_COLUMNS = {
	...
	indexed_files: ['path', 'source_scope', 'size_bytes', 'mtime_ms', 'ctime_ms', 'file_identity', 'content_hash', 'indexed_at', 'index_mode', 'parser_version'],
	indexed_source_candidates: ['path'],
	metadata: ['key', 'value'],
