...
export const hiMessages = {
  ...
  "command.crashEvidence.summary": "Bounded native crash evidence validate, collect और replay करें",
  ...
  "crashEvidence.help.summary": "Evidence validate करें, offline artifact normalize करें या deterministic race scenario replay करें।",
  "crashEvidence.help.exit.ok": "Operation rejected contract के बिना पूरी हुई",
  "crashEvidence.help.exit.fail": "Usage, input, output, collection या race validation विफल हुआ",
  "crashEvidence.error.missingAction": "crash-evidence action दें: validate, collect या race",
  "crashEvidence.error.unknownAction": "अज्ञात crash-evidence action: {action}",
  "crashEvidence.error.missingPath": "Crash evidence record path missing है",
  "crashEvidence.error.notFile": "Crash evidence path regular file होना चाहिए।",
  "crashEvidence.error.tooLarge": "Crash evidence 4 MiB validation limit से बड़ा है।",
  "crashEvidence.error.unreadable": "Crash evidence पढ़ा नहीं जा सका: {message}",
  "crashEvidence.title": "mustflow crash-evidence validate",
  "crashEvidence.label.path": "Path",
  "crashEvidence.label.status": "Status",
  "crashEvidence.label.readiness": "Readiness",
  "crashEvidence.label.modules": "Modules",
  "crashEvidence.label.threads": "Threads",
  "crashEvidence.label.frames": "Frames",
  "crashEvidence.label.issues": "Issues",
  "crashEvidence.value.valid": "valid",
  "crashEvidence.value.invalid": "invalid",
