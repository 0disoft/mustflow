...
export const frMessages = {
  ...
  "command.crashEvidence.summary": "Valide, collecte et rejoue des preuves bornées de crash natif",
  ...
  "command.plugin.summary": "Crée des bundles Agent Plugin portables",
  ...
  "crashEvidence.help.summary": "Valide les preuves, normalise les artefacts hors ligne ou rejoue un scénario déterministe.",
  "crashEvidence.help.exit.ok": "L'opération s'est terminée sans contrat rejeté",
  "crashEvidence.help.exit.fail": "Échec d'utilisation, d'entrée, de sortie, de collecte ou de validation de course",
  "crashEvidence.error.missingAction": "Indiquez une action crash-evidence : validate, collect ou race",
  "crashEvidence.error.unknownAction": "Action crash-evidence inconnue : {action}",
  "crashEvidence.error.missingPath": "Chemin de la preuve de crash manquant",
  "crashEvidence.error.notFile": "Le chemin de preuve doit être un fichier normal.",
  "crashEvidence.error.tooLarge": "La preuve dépasse la limite de validation de 4 Mio.",
  "crashEvidence.error.unreadable": "Impossible de lire la preuve de crash : {message}",
  "crashEvidence.title": "mustflow crash-evidence validate",
  "crashEvidence.label.path": "Chemin",
  "crashEvidence.label.status": "État",
  "crashEvidence.label.readiness": "Préparation",
  "crashEvidence.label.modules": "Modules",
  "crashEvidence.label.threads": "Threads",
  "crashEvidence.label.frames": "Frames",
  "crashEvidence.label.issues": "Problèmes",
  "crashEvidence.value.valid": "valide",
  "crashEvidence.value.invalid": "invalide",
