export const enMessages = {
  ...
  "command.crashEvidence.summary": "Validate, collect, and replay bounded native crash evidence",
  ...
  "command.plugin.summary": "Build portable Agent Plugin bundles",
  ...
  "crashEvidence.help.summary": "Validate evidence, normalize offline artifacts, or replay a deterministic race scenario.",
  "crashEvidence.help.exit.ok": "The requested operation completed without a rejected contract",
  "crashEvidence.help.exit.fail": "Usage, input, output, collection, or race validation failed",
  "crashEvidence.error.missingAction": "Specify a crash-evidence action: validate, collect, or race",
  "crashEvidence.error.unknownAction": "Unknown crash-evidence action: {action}",
  "crashEvidence.error.missingPath": "Missing crash evidence record path",
  "crashEvidence.error.notFile": "Crash evidence path must be a regular file.",
  "crashEvidence.error.tooLarge": "Crash evidence is larger than the 4 MiB validation limit.",
  "crashEvidence.error.unreadable": "Could not read crash evidence: {message}",
