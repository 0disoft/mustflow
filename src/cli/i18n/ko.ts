...
export const koMessages = {
  ...
  "command.crashEvidence.summary": "범위가 제한된 네이티브 크래시 증거를 검증, 수집, 재현합니다",
  ...
  "crashEvidence.help.summary": "증거를 검증하고 오프라인 아티팩트를 정규화하거나 결정적 race 시나리오를 재현합니다.",
  "crashEvidence.help.exit.ok": "요청 작업이 거부된 계약 없이 완료되었습니다",
  "crashEvidence.help.exit.fail": "사용법, 입력, 출력, 수집 또는 race 검증에 실패했습니다",
  "crashEvidence.error.missingAction": "crash-evidence 작업을 지정하세요: validate, collect 또는 race",
  "crashEvidence.error.unknownAction": "알 수 없는 crash-evidence 작업: {action}",
  "crashEvidence.error.missingPath": "크래시 증거 기록 경로가 없습니다",
  "crashEvidence.error.notFile": "크래시 증거 경로는 일반 파일이어야 합니다.",
  "crashEvidence.error.tooLarge": "크래시 증거가 4 MiB 검증 제한보다 큽니다.",
  "crashEvidence.error.unreadable": "크래시 증거를 읽을 수 없습니다: {message}",
  "crashEvidence.title": "mustflow crash-evidence validate",
  "crashEvidence.label.path": "경로",
  "crashEvidence.label.status": "상태",
  "crashEvidence.label.readiness": "분석 준비도",
  "crashEvidence.label.modules": "모듈",
  "crashEvidence.label.threads": "스레드",
  "crashEvidence.label.frames": "프레임",
  "crashEvidence.label.issues": "문제",
  "crashEvidence.value.valid": "유효함",
  "crashEvidence.value.invalid": "유효하지 않음",
  ...
  "dashboard.update.wouldRemove": "제거 예정",
...
<!-- mustflow:end -->`,
  ...
  "update.complete": "mustflow update 완료: 갱신 {updated}, 생성 {created}, 제거 {removed}.",
