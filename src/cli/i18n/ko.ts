...
export const koMessages = {
	...
	'command.dashboard.summary': '로컬 mustflow 대시보드를 엽니다. 아직 구현되지 않았습니다',
	'command.help.summary': '설치된 작업 흐름 도움말을 보여줍니다',

	'top.help.option.lang': 'CLI 출력 언어를 선택합니다. 지원값: {languages}',
	'top.help.option.version': '패키지 버전을 보여줍니다',
	'top.help.exit.ok': '명령이 완료되었거나 요청한 정보를 출력했습니다',
	'top.help.exit.fail': '명령이 실패했거나 검증 문제 또는 잘못된 입력이 있었습니다',

	'check.help.summary': '현재 저장소의 mustflow 파일을 검사합니다.',
	'check.help.option.strict': '에이전트 안전성에 대한 추가 엄격 검사를 실행합니다',
	'check.help.exit.ok': '필수 mustflow 파일과 설정이 모두 유효합니다',
	'check.help.exit.fail': '검증 실패 또는 잘못된 입력이 있었습니다',
	...
	'dashboard.help.summary': '로컬 mustflow 대시보드 명령을 예약합니다. 이 기능은 아직 구현되지 않았습니다.',
	'dashboard.help.exit.ok': '도움말을 출력했습니다',
	'dashboard.help.exit.notImplemented': '대시보드 기능이 아직 구현되지 않았습니다',
	'dashboard.notImplemented': 'mf dashboard는 아직 구현되지 않은 기능입니다',

	'doctor.help.summary': '파일을 수정하지 않고 mustflow 루트 상태와 다음 작업 단서를 점검합니다.',
	'doctor.help.option.json': '기계가 읽기 쉬운 JSON 진단 결과를 출력합니다',
	'doctor.help.option.strict': '에이전트 안전성에 대한 추가 엄격 검사를 포함합니다',
	...
	'doctor.diagnostic.commands': '명령 계약',
	...
	'help.commands.configuredIntents': '.mustflow/config/commands.toml에 설정된 명령 의도:',
	'help.preferences.title': '선호값',
	'help.preferences.intro': '.mustflow/config/preferences.toml의 저장소별 에이전트 선호값:',
	...
	'index.help.summary': 'mustflow 문서 흐름을 재생성 가능한 SQLite 색인으로 만듭니다.',
	'index.help.option.dryRun': '색인 대상만 계산하고 파일을 쓰지 않습니다',
	'index.help.exit.ok': '색인 대상을 계산했고 선택적으로 SQLite 파일을 썼습니다',
...
<!-- mustflow:end -->`,
	'init.help.summary': '현재 저장소에 기본 mustflow 에이전트 작업 흐름을 복사합니다.',
	...
	'init.help.option.profile': '프로젝트 성격을 설정합니다: minimal, oss, team, product, library',
	'init.help.option.locale': '설치할 mustflow 문서 언어를 설정합니다',
	'init.help.option.agentLang': '에이전트 보고 언어를 설정합니다',
	'init.help.option.productSourceLocale': '제품 사용자 문구의 기준 언어를 설정합니다',
	'init.help.option.productLocale': '제품 사용자 대상 로케일을 추가합니다. 반복할 수 있습니다',
	'init.help.exit.ok': '설치 완료, 변경 없음, 또는 계획 출력',
	...
	'map.help.summary': '저장소 앵커 파일을 기준으로 에이전트 탐색 지도를 생성합니다.',
	'map.help.option.stdout': '생성한 지도를 출력합니다',
	'map.help.option.write': 'REPO_MAP.md를 씁니다',
	'map.help.option.depth': '우선순위가 낮은 앵커 디렉터리 깊이를 제한합니다',
	'map.help.option.includeNested': '설정된 작업대 루트의 하위 저장소를 포함합니다',
	...
	'run.help.summary': '.mustflow/config/commands.toml에 설정된 끝나는 명령 의도를 실행합니다.',
	'run.help.option.json': '실행 결과 영수증을 JSON으로 출력합니다',
	'run.help.exit.ok': '명령 의도가 허용된 종료 코드로 끝났습니다',
	'run.help.exit.fail': '의도가 잘못되었거나, 거부되었거나, 제한 시간을 넘겼거나, 실패했습니다',
	'run.error.missingIntent': '명령 의도 이름이 없습니다',
	'run.error.unknownIntent': '알 수 없는 명령 의도: {intent}',
	'run.error.statusNotConfigured': '의도 "{intent}"의 상태는 {status}입니다. configured 상태인 의도만 실행할 수 있습니다',
	'run.error.lifecycleNotOneshot': '거부됨: 의도 "{intent}"의 lifecycle은 "{lifecycle}"입니다. mf run은 oneshot 의도만 실행합니다',
	'run.error.runPolicy': '의도 "{intent}"는 mf run에서 실행하려면 run_policy = "agent_allowed"가 필요합니다',
	'run.error.stdin': '의도 "{intent}"는 stdin = "closed"를 설정해야 합니다',
	'run.error.timeout': '의도 "{intent}"는 timeout_seconds를 정의해야 합니다',
	'run.error.commandSource': '의도 "{intent}"는 argv를 정의하거나 mode = "shell"과 cmd를 함께 정의해야 합니다',
	'run.error.timedOut': '의도 "{intent}"가 {seconds}초 뒤 시간 초과되었습니다',
	'run.error.startFailed': '의도 "{intent}"를 시작하지 못했습니다: {message}',

	'search.help.summary': '로컬 SQLite 색인에서 mustflow 문서 흐름을 검색합니다.',
	...
	'status.help.summary': '파일을 수정하지 않고 로컬 mustflow 설치 상태를 보여줍니다.',
	...
	'update.help.exit.fail': '차단된 작업, 누락된 상태, 또는 잘못된 입력이 있습니다',
	...
	'update.policy.applyActions': '적용 가능 상태',
	'update.policy.blockingActions': '차단 상태',
