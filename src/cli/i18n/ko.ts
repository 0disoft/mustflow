...
<!-- mustflow:end -->`,
  ...
  "scriptPack.script.codeRouteOutline.summary": "Hono와 Elysia route method, path, lifecycle chain을 스캔합니다",
  ...
  "codeRouteOutline.help.summary": "Hono와 Elysia TypeScript 또는 JavaScript 소스 파일에서 route method, path, framework, lifecycle chain, line metadata를 스캔합니다.",
  ...
  "codeRouteOutline.clean": "Hono 또는 Elysia route를 찾지 못했습니다.",
