...
<!-- mustflow:end -->`,
  ...
  "scriptPack.script.codeRouteOutline.summary": "Hono, Elysia, Axum route method, path, handler, lifecycle chain을 스캔합니다",
  ...
  "codeRouteOutline.help.summary": "Hono, Elysia, Axum route 소스 파일에서 method, path, handler, framework, lifecycle chain, line metadata를 스캔합니다.",
  ...
  "codeRouteOutline.clean": "Hono, Elysia, Axum route를 찾지 못했습니다.",
