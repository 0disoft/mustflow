...
export const esMessages = {
  ...
  "command.crashEvidence.summary": "Valida, recopila y reproduce evidencia acotada de fallos nativos",
  ...
  "command.plugin.summary": "Crea paquetes Agent Plugin portátiles",
  ...
  "crashEvidence.help.summary": "Valida evidencia, normaliza artefactos sin conexión o reproduce un escenario determinista.",
  "crashEvidence.help.exit.ok": "La operación terminó sin un contrato rechazado",
  "crashEvidence.help.exit.fail": "Falló el uso, la entrada, la salida, la recopilación o la validación de carrera",
  "crashEvidence.error.missingAction": "Indica una acción crash-evidence: validate, collect o race",
  "crashEvidence.error.unknownAction": "Acción crash-evidence desconocida: {action}",
  "crashEvidence.error.missingPath": "Falta la ruta del registro de evidencia",
  "crashEvidence.error.notFile": "La ruta de evidencia debe ser un archivo normal.",
  "crashEvidence.error.tooLarge": "La evidencia supera el límite de validación de 4 MiB.",
  "crashEvidence.error.unreadable": "No se pudo leer la evidencia: {message}",
  "crashEvidence.title": "mustflow crash-evidence validate",
  "crashEvidence.label.path": "Ruta",
  "crashEvidence.label.status": "Estado",
  "crashEvidence.label.readiness": "Preparación",
  "crashEvidence.label.modules": "Módulos",
  "crashEvidence.label.threads": "Hilos",
  "crashEvidence.label.frames": "Marcos",
  "crashEvidence.label.issues": "Problemas",
  "crashEvidence.value.valid": "válido",
  "crashEvidence.value.invalid": "no válido",
...
<!-- mustflow:end -->`,
  ...
  "flow.help.summary":
    "Genera REPO_FLOW.md, un mapa de flujo de diseno para la raiz mustflow actual.",
  ...
  "run.help.option.noWait": "Falla de inmediato si otra ejecución activa posee un recurso en conflicto",
  "run.help.option.waitTimeout": "Segundos máximos para esperar bloqueos activos. Predeterminado: 300",
  "run.help.option.input": "Asocia una entrada tipada declarada; repite la opción para varias entradas",
