...
export const zhMessages = {
  ...
  "command.crashEvidence.summary": "验证、收集并重放有界的原生崩溃证据",
  ...
  "crashEvidence.help.summary": "验证证据、规范化离线产物或重放确定性 race 场景。",
  "crashEvidence.help.exit.ok": "请求操作完成且没有被拒绝的契约",
  "crashEvidence.help.exit.fail": "用法、输入、输出、收集或 race 验证失败",
  "crashEvidence.error.missingAction": "请指定 crash-evidence 操作：validate、collect 或 race",
  "crashEvidence.error.unknownAction": "未知 crash-evidence 操作：{action}",
  "crashEvidence.error.missingPath": "缺少崩溃证据记录路径",
  "crashEvidence.error.notFile": "崩溃证据路径必须是普通文件。",
  "crashEvidence.error.tooLarge": "崩溃证据超过 4 MiB 验证限制。",
  "crashEvidence.error.unreadable": "无法读取崩溃证据：{message}",
  "crashEvidence.title": "mustflow crash-evidence validate",
  "crashEvidence.label.path": "路径",
  "crashEvidence.label.status": "状态",
  "crashEvidence.label.readiness": "分析就绪度",
  "crashEvidence.label.modules": "模块",
  "crashEvidence.label.threads": "线程",
  "crashEvidence.label.frames": "帧",
  "crashEvidence.label.issues": "问题",
  "crashEvidence.value.valid": "有效",
  "crashEvidence.value.invalid": "无效",
...
<!-- mustflow:end -->`,
  ...
  "flow.help.summary":
    "为当前 mustflow 根生成设计流程图 REPO_FLOW.md。",
