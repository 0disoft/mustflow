...
const PUBLIC_JSON_SCHEMA_CONTRACTS: readonly PublicJsonSchemaContract[] = [
	...
	{
		id: 'native-crash-evidence-validation-report',
		schemaFile: 'native-crash-evidence-validation-report.schema.json',
		producer: 'mf crash-evidence validate <path> --json',
		packaged: true,
		documented: true,
		expectedExitCodes: [0, 1],
	},
	{
		id: 'native-crash-evidence-collection-report',
		schemaFile: 'native-crash-evidence-collection-report.schema.json',
		producer: 'mf crash-evidence collect <path> --adapter <name> --output <path> --json',
		packaged: true,
		documented: true,
		expectedExitCodes: [0, 1],
	},
	{
		id: 'deterministic-race-scenario',
		schemaFile: 'deterministic-race-scenario.schema.json',
		producer: 'input to mf crash-evidence race <path> --json',
		packaged: true,
		documented: true,
	},
	{
		id: 'deterministic-race-report',
		schemaFile: 'deterministic-race-report.schema.json',
		producer: 'mf crash-evidence race <path> --json',
		packaged: true,
		documented: true,
		expectedExitCodes: [0, 1],
	},
