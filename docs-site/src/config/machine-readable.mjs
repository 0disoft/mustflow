...
export const machineReadable = {
	...
	coreLinks: [
		...
		pageLink('repoFlow', 'Optional generated repository design-flow map for agents'),
		...
		{ label: 'mf flow', path: '/commands/flow/', note: 'CLI command that generates REPO_FLOW.md' },
