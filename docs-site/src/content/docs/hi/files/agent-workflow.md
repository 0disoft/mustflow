...
- `Version impact policy`: जांचता है कि change के लिए version bump suggest करना चाहिए या नहीं, पर automatic version edits को default रूप से disabled रखता है।
