...
- agent-facing workflow surfaces के लिए install scope घोषित करता है।
...
- `scope`: इस template द्वारा उपयोग की जाने वाली default agent-facing install surface का नाम है।
...
यह `.mustflow/context/**` बना सकता है, क्योंकि वे files task-specific agent workflow context हैं, सामान्य project documentation नहीं।
