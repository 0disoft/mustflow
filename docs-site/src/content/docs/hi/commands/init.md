...
`common/` में language-neutral TOML configuration होती है। `locales/<locale>/` में `--locale` द्वारा चुने गए Markdown documents और skill files होते हैं।
...
- `manifest.lock.toml` installed-file hashes, template identifier और हर file पर की गई action record करता है।
