...
It checks installation state, mustflow validation, changed files, verification requirements, runnable configured intents, and command-contract gaps. It does not run commands, modify files, or grant command authority.
