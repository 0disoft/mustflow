...
- Hace que el agente revise `.mustflow/skills/INDEX.md` y lea el `SKILL.md` correspondiente
  antes de editar el alcance afectado.
...
`AGENTS.md` solo debe declarar la obligación de seleccionar skills. Las reglas detalladas de selección
pertenecen a `.mustflow/skills/INDEX.md` y `.mustflow/docs/agent-workflow.md`.
